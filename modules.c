...
void promedioNotas() // 01. Ronald
{
    ...
    do
    {
        ...
        sumaTotal = 0;
        printf("\n\t\tPROMEDIO DE NOTAS\n\n");
        printf("Cantidad de notas a evaluar: ");
        nNotas = validInt();
...
void areaDeFiguras() // 09. Ronald
{
    ...
    do
    {
        ...
        case 3:
            ...
            printf("\n\tBase menor: ");
            baseMenor = validFloat();
            printf("\tBase mayor: ");
            baseMayor = validFloat();
            printf("\tAltura: ");
            altura = validFloat();
...
// 4. Determinar el salario de un empleado de una compañía con base en el
// salario básico
void salario()
{
    do
...
// 6. Calcular ley de ohm (v = R*I). Permite elijir si
// calcular,(V)Voltaje,(R)resistencia,(I)corriente
void leyOHM()
{
    do
    {
...
// 10. Hallar la suma y el promedio de los primeros 20 numeros enteros mayores a
// 0
void sumaProm20()
{
    do
    {
        ...
        float prom = 0, suma = 0;
        CLS;
        printf("\n\tHallar la suma y el promedio de los primeros 20 numeros "
               "enteros mayores a 0");
        i = 1;
        printf("\n\n");
        do
...
// 12. Calcular el cuadrado y el cubo de los 15 primeros números mayores que
// cero
void cuadradoCubo()
{
    do
...
// 26. Determinar si un numero es menor que 10 o mayor que 100 o si esta entre
// 10 y 100
void numero1_100()
{
...
void minimoVector()
{
    ...
    {
        CLS;
        printf("\n\tCalcular minimo de un vector de 10 numeros y mostrar su "
               "posicion\n");
